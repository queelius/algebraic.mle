...
to the MLE. To find a good starting point, we use a global search
method, Simulated Annealing, which is implemented in the `optim` function
in R. Here is the code for finding a good starting point:
```{r}
...
ggplot(df, aes(x = Value, fill = Group)) +
  ...
  scale_fill_manual(values = c("Weibull"="red", Normal="green", True="purple")) +
